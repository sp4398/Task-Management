...
// to fetch added tasks
  ...
  return (
    <div style={{width:'50%',maxWidth:'300px'}} className='todo'>
        <h2>Todo Application</h2>
         ...
         className='date'
          /> <br/><br/>
         {
           edit_todo===null?(<button onClick={addStuff} className='btn btn-success'>Add Stuff</button>):(
            <button onClick={()=>editStuff(edit_todo)} className='btn btn-success'>Edit Stuff</button>
           )
         } 
         </div>
    </div>
